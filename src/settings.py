...
in_memory_models = OrderedDict({
    ...
    'stanza-de': stanza.Pipeline(lang='de', processors='tokenize,mwt,pos,lemma', use_gpu=False),
    'stanza-it': stanza.Pipeline(lang='it', processors='tokenize,mwt,pos,lemma', use_gpu=False),
    'stanza-el': stanza.Pipeline(lang='el', processors='tokenize,mwt,pos,lemma', use_gpu=False)
})
